...
Another compeling reason for dropping them was the fact that they had  lower explanatory power (R-squared and adj-R squared) compared to the models without interaction. In the model with interaction term (categorical), only 71% of the variability in the number of flowers is explained by covariates  while in the continuous case with interaction  77% of the variability in the number of flowers is explained by the covariates.
